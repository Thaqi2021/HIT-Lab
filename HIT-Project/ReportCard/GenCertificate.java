...
public class GenCertificate {
	static void certify(String pdfName,String studentName) throws Exception {
		try {
			...
			Image image = Image.getInstance(imgpath);
					...
					String headerData = "CERTIFICATE OF COMPLETION";
					
					String providerName="Mr Mohammed Shouib";

					String midData = "Course on:JAVA FULLSTACK DEVELOPMENT\n\n"
							+ "Successfully Completed the Course and Completed on-time"
							+ " and his participation very good. The programming language used in this"
							+ " Course is \"JAVA\", \"MERN\" and \"MEAN\" as a JAVA FULLSTACK DEVELOPMENT."
					...
					setData(pdfStamper, "This is to Certify that", BaseFont.TIMES_BOLDITALIC, 18, BaseColor.WHITE, 500, 440, 80,360);

					setData(pdfStamper, studentName, BaseFont.TIMES_BOLDITALIC, 30, BaseColor.LIGHT_GRAY, 530, 416, 80, 360);
					setData(pdfStamper, midData, BaseFont.TIMES_BOLDITALIC, 14, BaseColor.WHITE, 530, 220, 75, 340);
					...
					setData(pdfStamper, seal, BaseFont.TIMES_BOLDITALIC, 14, BaseColor.WHITE, 380, 220, 950, 100);
